...
namespace Exam.Pages
{
    ...
    public partial class LoginPage : Page
    {
        ...
        /// <summary>
        /// Событие при нажатию кнопки входа в аккаунт
        /// </summary>
        private void LoginButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Логин или пароль указаны неверно", "Ошибка входа", MessageBoxButton.OK, MessageBoxImage.Error);
                return;
            }
        ...
        /// <summary>
        /// Событие при изменении текста в поле для ввода капчи
        /// </summary>
        ...
        private void LoadCaptcha()
        {
            ...
            var font = new Font("Comic Sans MS", 30, System.Drawing.FontStyle.Italic, GraphicsUnit.Pixel);
        ...
        /// <summary>
        /// Событие по нажатию на кнопку обновления капчи
        /// </summary>
        ...
        /// <summary>
        /// Блокировка кнопки входа в аккаунт
        /// </summary>
        private async void BlockButton()
        {
            LoginButton.IsEnabled = false;
            await Task.Delay(2000); //1000 миллисекунд = 1 секунда
